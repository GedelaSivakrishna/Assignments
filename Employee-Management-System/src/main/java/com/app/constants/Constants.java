...
public class Constants {
    ...
    public static final String INVALID_EMPLOYEE_JOINED_IN_ARGUMENTS = "Excepted Key values y,year,years | m,month,months | w,week,weeks | d,day,days but got =";
    public static final String INVALID_PAGINATION_SIZE = "Invalid size";
    public static final String INVALID_PAGINATION_SORTBY_COLUMN_NAME  = "Expected column names [id, name, email, salary, dataOfJoining] but got";
    public static final String INVALID_PAGINATION_SORTING_ORDER  = "Invalid sorting order. Expected [asc, desc] but found";
    public static final String EMPLOYEES_NOT_FOUND = "No Employees found in the database";
    public static final String INVALID_SALARY_INCREMENT_PERCENT = "Invalid! Enter a valid percent value";
    public static final String SALARY_INCREMENT_SUCCESS = "All employees salary updated successfully";
