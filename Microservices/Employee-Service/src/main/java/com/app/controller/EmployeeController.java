...
public class EmployeeController {
    ...
    public ResponseEntity<PerformanceDto> createEmployeePerformanceHandler(@RequestParam("empId") int employeeId,
                                                                           @RequestBody PerformanceDto performanceDto) {
        return employeeService.createEmployeePerformance(employeeId, performanceDto);
    }
    ...
    @GetMapping("employee/week/feedback")
    public ResponseEntity<PerformanceDto> viewEmployeeWeeklyPerformance(@RequestParam("empId") int employeeId,
                                                                        @RequestParam("wId") int weekId) {
        return employeeService.viewEmployeeWeeklyPerformance(employeeId, weekId);
    }

    @GetMapping("employee/top/performance")
    public ResponseEntity<String> topPerformingEmployeeHandler() {
        String topPerformingEmployeeName = employeeService.topPerformingEmployee();
        String response = "Top performing employee: " + topPerformingEmployeeName;
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    @GetMapping("employee/least/performance")
    public ResponseEntity<String> leastPerformingEmployeeHandler() {
        String leastPerformingEmployeeName = employeeService.leastPerformingEmployee();
        String response = "Least performing employee: " + leastPerformingEmployeeName;
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    @PutMapping("employee/feedback/update")
    public ResponseEntity<PerformanceDto> updateEmployeeFeedbackHandler(@RequestParam("empId") int employeeId,
                                                                        @RequestParam("wId") int weekId,
                                                                        @RequestBody PerformanceDto updatedPerformance) {
        return employeeService.updateEmployeeWeeklyPerformance(employeeId, weekId, updatedPerformance);
    }
}
